                            ...
                            <div class="tab-pane fade" id="detail-tab-pane" role="tabpanel" aria-labelledby="detail-tab"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3 form-group">
                                        ...
                                        <input type="text" name="original_price" class="form-control generate-slug" value="{{ old('original_price') }}" />
                                    ...
                                    <div class="col-md-4 mb-3 form-group">
                                        ...
                                        <input type="text" name="selling_price" class="form-control generate-slug" value="{{ old('selling_price') }}" />
                                        @error('selling_price')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3 form-group">
                                        ...
                                        <input type="text" name="quantity" class="form-control generate-slug" value="{{ old('quantity') }}" />
                                        @error('quantity')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
