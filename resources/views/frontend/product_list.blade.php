                ...
                <div class="col-lg-9">
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p> We found <strong class="text-brand">{{ $productLists->total() }}</strong> items for you!</p>
                        </div>
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    ...
                    <div class="widget-category mb-30">
                        ...
                        <ul class="categories">
                            ...
                            <li><a href="{{ route('frontend.product.list', $cat->slug) }}">{{ $cat->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <!-- Fillter By Price -->
                    ...
                    <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                        ...
                        <div class="single-post clearfix">
                            ...
                            <div class="content pt-10">
                                <h5><a href="{{ route('frontend.product.detail', $prod->id) }}l">Chen Cardigan</a></h5>
                        ...
                        <div class="single-post clearfix">
                            ...
                            <div class="content pt-10">
                                <h6><a href="{{ route('frontend.product.detail', $prod->id) }}l">Chen Sweater</a></h6>
                        ...
                        <div class="single-post clearfix">
                            ...
                            <div class="content pt-10">
                                <h6><a href="{{ route('frontend.product.detail', $prod->id) }}l">Colorful Jacket</a></h6>
