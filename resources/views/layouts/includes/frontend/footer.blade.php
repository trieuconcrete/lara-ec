                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        <div class="logo logo-width-1 wow fadeIn animated">
                            <a href="{{ route('frontend.home') }}"><img src="{{ (isset($settings['logo_footer']) && $settings['logo_footer']) ? \Storage::url($settings['logo_footer']) : asset('assets/images/logo.png') }}" alt="logo"></a>
                        </div>
