                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="snow-editor" style="height: 240px;"></div>
                            </div>
                        </div>
                    </div>
                    <!-- end card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <input type="text" id="datepicker-publish-input" class="form-control" placeholder="Enter publish date" data-provider="flatpickr" data-date-format="Y-m-d" data-enable-time>
                            </div>
                        </div>
                    </div>
                    <!-- end card -->
