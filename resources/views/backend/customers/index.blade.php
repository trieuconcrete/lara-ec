                                ...
                                <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                    <thead class="table-light text-muted">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="avatar">Avatar</th>
                                            <th class="sort" data-sort="name">Name</th>
                                            <th class="sort" data-sort="register_date">Email</th>
                                            <th class="sort" data-sort="register_date">Phone</th>
                                            <th class="sort" data-sort="orders">Orders</th>
                                            <th class="sort" data-sort="total_amount">Total Amount</th>
                                            <th class="sort" data-sort="register_date">Register Date</th>
                                            <th class="sort" data-sort="register_date">Address</th>
